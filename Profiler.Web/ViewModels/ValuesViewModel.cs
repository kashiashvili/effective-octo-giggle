...
/// <summary>
/// The values questionnaire form. One 1–7 answer per item, keyed by item key. Bound as a dictionary
...
{
    /// <summary>Item key → 1–7 answer. Empty/partial is caught in the controller against the item set.</summary>
